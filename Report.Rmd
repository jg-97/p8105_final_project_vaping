...
1. How did drugs use in youth change over time in NYC?

2. How did mental health related issues in youth change over time in NYC?

3. How does drug use and mental health status differ by demographics in NYC youth?

4. Can we build a model with current available data to predict future vaping use?
