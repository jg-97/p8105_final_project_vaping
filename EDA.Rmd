...
* According to our survey data, it appears as if there is more vaping present among male teenagers in Brooklyn, Queens, and Staten Island.
...
Note that the plots shows only data for teenagers consuming the particular drug of interest.
