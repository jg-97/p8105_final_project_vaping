  ...
  if (input$grouping_choice_D == "nothing")
  {
    if (input$drugs_1 == "Marijuana") {
      df_11 = df_11 %>%
        ...
        mutate(current_marijuana_use = fct_recode(current_marijuana_use, "Yes" = "1 or more times")) %>% 
        mutate(current_marijuana_use = fct_recode(current_marijuana_use, "No" = "0 times")) %>% 
        count(current_marijuana_use) %>% 
        rename(x = current_marijuana_use)}
    else if (input$drugs_1 == "Alcohol") {
      df_11 = df_11 %>%
        filter(!(is.na(current_alcohol_use))) %>% 
        mutate(current_alcohol_use = fct_recode(current_alcohol_use, "Yes" = "1 or more days")) %>% 
        mutate(current_alcohol_use = fct_recode(current_alcohol_use, "No" = "0 days")) %>% 
        count(current_alcohol_use) %>% 
        rename(x = current_alcohol_use)}
    else if (input$drugs_1 == "Cigarettes") {
      df_11 = df_11 %>%
        filter(!(is.na(current_cigarette_use))) %>% 
        mutate(current_cigarette_use = fct_recode(current_cigarette_use, "Yes" = "1 or more days")) %>% 
        mutate(current_cigarette_use = fct_recode(current_cigarette_use, "No" = "0 days")) %>% 
        count(current_cigarette_use) %>% 
        rename(x = current_cigarette_use)}
    else if (input$drugs_1 == "Vaping") {
      df_11 = df_11 %>%
        filter(!(is.na(current_vaping))) %>% 
        mutate(current_vaping = fct_recode(current_vaping, "Yes" = "1 or more days")) %>% 
        mutate(current_vaping = fct_recode(current_vaping, "No" = "0 days")) %>% 
      ...
      df_11 = df_11 %>%
        ...
        mutate(current_smokeless_tobacco_use = fct_recode(current_smokeless_tobacco_use, "Yes" = "1 or more days")) %>% 
        mutate(current_smokeless_tobacco_use = fct_recode(current_smokeless_tobacco_use, "No" = "0 days")) %>% 
      ...
      df_11 = df_11 %>%
        ...
        mutate(current_cigar_use = fct_recode(current_cigar_use, "Yes" = "1 or more days")) %>% 
        mutate(current_cigar_use = fct_recode(current_cigar_use, "No" = "0 days")) %>% 
  ...
  if (input$grouping_choice_M == "nothing")
  {
    if (input$mental_health_1 == "feel sad or hopeless") {
      df_21 = df_21 %>%
        ...
        mutate(sad_hopeless = fct_recode(sad_hopeless, "Yes" = "yes")) %>% 
        mutate(sad_hopeless = fct_recode(sad_hopeless, "No" = "no")) %>% 
        count(sad_hopeless) %>% 
        rename(x = sad_hopeless)}
    else if (input$mental_health_1 == "attempted suicide") {
      df_21 = df_21 %>%
        filter(!(is.na(attempted_suicide))) %>% 
        mutate(attempted_suicide = fct_recode(attempted_suicide, "Yes" = "at least 1 time")) %>% 
        mutate(attempted_suicide = fct_recode(attempted_suicide, "No" = "0 times")) %>% 
      ...
      df_21 = df_21 %>%
        ...
        mutate(injurious_suicide_attempt = fct_recode(injurious_suicide_attempt, "Yes" = "yes")) %>% 
        mutate(injurious_suicide_attempt = fct_recode(injurious_suicide_attempt, "No" = "did not attempt suicide/no")) %>% 
