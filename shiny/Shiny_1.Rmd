...
radioButtons(
  "grouping_choice_RV", 
  label = h3("Group by"),
  choices = c("texting and driving", "drinking and driving", "carring weapon", "safety concerns at school", "threatened at school", "physical fighting", "bullying at school", "bullying electronically"))
```
...
renderPlotly({
  ...
  if (input$grouping_choice_RV == "texting and driving")
  {
  ...
  else if (input$grouping_choice_RV == "drinking and driving")
  {
    if (input$drugs_3 == "Marijuana") {
      df_13 = df_13 %>%
